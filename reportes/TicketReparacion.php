...
$rspta = $reparacion->ventacabecera($_GET["id"]);
...
<table border="0" align="center" width="300px">
    ...
    <?php
    $rsptad = $reparacion->ventadetalle($_GET["id"]);
    $cantidad=0;
    while ($regd = $rsptad->fetch_object()) {
        echo "<tr>";
        echo "<td>".$regd->equipo."</td>";
        echo "<td>".$regd->detalles;
        echo "<td align='right'>C$/ ".$regd->precio."</td>";
        echo "</tr>";
        $precio = $regd->precio;
    }
    ?>
    ...
    <td align="right"><b>C$/  <?php echo $precio;  ?></b></td>
    </tr>
    <tr>
