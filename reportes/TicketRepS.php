...
$rspta = $solares->cabeceraTicket($_GET["id"]);
$reg = $rspta->fetch_object();

$restante = $solares->restanteTicket($_GET["id"]);
...
<table border="0"  width="100px" >
    ...
    $rsptad = $solares->abonoDetalle($_GET["id"]);
    $cantidad=0;
    ...
    <tr>
        ...
        <td align="left"><b>Prima:</b></td>


        <td><b> <?php echo $recorreres->prima;  ?></b></td>
