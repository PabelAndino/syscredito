...
$rspta = $financiamiento->ticketNuevaCuenta($_GET["id"]);
...
<table border="1"  width="300px">
    ...
    <tr>
        <td>Nº de cuenta: <?php echo " - ".$reg->idfinanciamiento ; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Articulo: <?php echo " - ".$reg->articulo ; ?></td>
    </tr>
</table>
<br>
...
<table border="0"  width="100px" >
    ...
    $rsptad = $financiamiento->ticketNuevaCuenta($_GET["id"]);
    $cantidad=0;
