                        ...
                        <div class="box">
                            ...
                            <div class="panel-body" style="height: 400px;" id="formularioregistros">
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-43 col-xs-12">
                                        <label>Tipo(*):</label>
                                        <select class="form-control selectpicker" name="tipo_persona" id="tipo_persona" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label>Genero(*):</label>
                                        <select class="form-control selectpicker" name="generoCliente" id="generoCliente" required>
