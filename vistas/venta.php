                            ...
                            <div class="panel-body" style="height: 800px;" id="formularioregistros">
                                ...
                                <form name="formulario" id="formulario" method="POST">
                                    <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <select id="idcliente" name="idcliente" class="form-control selectpicker" data-size="4" data-live-search="true" required>
                                    ...
                                    <button id="fiado" type="button" class="btn btn-warning active" onclick="calculaCredito()"> <span class="fa fa-bank"></span> Financiado</button>
