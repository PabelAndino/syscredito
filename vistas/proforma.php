                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h1 class="p-3 mb-2 bg-gray-active text-white">Proforma
                                </h1>
                                <div class="box-tools pull-right">
                                </div>
                            </div>
                            <div class="panel-body">
                                <button class="btn btn-success" id="btnagregar" onclick="mostrarForm2(true)"><i class="fa fa-plus-circle"></i> Agregar</button>
                            </div>
                            <!-- /.box-header -->
                            <!-- centro -->
