                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <div class="panel-body"><!--Intereses cantidades totales-->
                                <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    <label>Monto:</label>
                                    <input type="text" class="form-control" placeholder="Abonos Capital" name="monto_ncuenta" id="monto_ncuenta"  onkeypress="mascara(this,cpf)" maxlength="10" step=".01" min="0" >
                                </div>

                                <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    <label>Interés:</label>
                                    <input type="text" class="form-control" name="interes" id="interes" maxlength="7" placeholder="Intereses"  >
                                </div>
                                <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    <label>Mantenimiento:</label>
                                    <input type="number" class="form-control" name="mantenimiento" id="mantenimiento" maxlength="7" placeholder="Mantenimiento de valor" step=".01" min="0" >
                                </div>
                                <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    <label>Interés Moratorio:</label>
                                    <input type="number" class="form-control" name="interes_moratorio" id="interes_moratorio" maxlength="7" placeholder="Interes Moratorio" step=".01" min="0" >
                                </div>

                                <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    <label>Total:</label>
                                    <input type="text" class="form-control" name="total" id="total" maxlength="7" placeholder="Total"  >
                                </div>
                            ...
                            <div class="panel-body table-responsive" id="listadonuevacuenta ">
                                ...
                                <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    ...
                                    <input type="number" class="form-control" name="tipo_cambio" id="tipo_cambio" VALUE="0.00"axlength="7" placeholder="Tipo Cambio" step=".01" min="0" >
                                </div>
