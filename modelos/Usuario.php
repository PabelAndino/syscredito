...
Class Usuario
{
    ...
    public function insertar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clave,$imagen,$permisos)
    {
        ...
        while ($numero_elementos < count($permisos))
        {
            $sql_detalle="INSERT INTO usuario_permiso(idusuario,idpermiso) VALUES ('$idusuarionuevo', '$permisos[$numero_elementos]')";
    ...
    public  function listamarcados($idusuarios)
    {
        $sql = "SELECT * FROM usuario_permiso WHERE idusuario = '$idusuarios'";
        return ejecutarConsulta($sql);
    }
